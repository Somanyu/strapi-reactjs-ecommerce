        ...
        <section>
          ...
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <header>
              ...
              {/* <h2 className="text-xl font-primary font-bold text-gray-900 sm:text-3xl">Product Collection</h2> */}
            ...
            <div className="mt-4 lg:mt-8 lg:grid lg:grid-cols-4 lg:items-start lg:gap-8">
              <div className="hidden space-y-4 lg:block sticky top-28">
                ...
                <h3 className="mb-2 font-primary font-semibold text-gray-900 dark:text-white">Sort by</h3>
                <ul className="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                  <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div className="flex items-center pl-3">
                      ...
                      <label htmlFor="asc" className="w-full font-secondary py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Lowest Price </label>
                    </div>
                  </li>
                  ...
                  <li className="w-full dark:border-gray-600">
                    <div className="flex items-center pl-3">
                      ...
                      <label htmlFor="desc" className="w-full font-secondary py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Highest Price</label>
                    </div>
                  </li>
                </ul>

                <div className='my-10'>
                  <h3 className="font-primary font-semibold text-gray-900 dark:text-white">Subcategory</h3>
                          ...
                          {loading ? <>Loading...</> : error ? <>Error...</> : data?.map(item => (
                            <li key={item.id}>
                              <label htmlFor={item.id} className="inline-flex items-center gap-2">
                                ...
                                <span className="text-sm font-secondary font-medium text-gray-700">{item.attributes.title}</span>
                              </label>
                            </li>
                          ))}
                        </ul>

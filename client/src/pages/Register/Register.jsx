                ...
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            <h1 className="text-xl font-dynaPuff font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                                Create an account
                            </h1>
                                        ...
                                        <Form>
                                            ...
                                            <div className='mt-2'>
                                                <div className="flex gap-2">
                                                    <label htmlFor="username" className="after:content-['*'] after:ml-0.5 after:text-red-500 block font-medium font-fredoka text-base text-gray-900 dark:text-gray-300">Username</label>
                                                ...
                                                <div className="relative flex items-center mt-2">
                                                    ...
                                                    <Field type="text" name="username" id="username" className="block w-full font-fredoka py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Username" />

                                                    {/* <input type="text" value={user.username} onChange={handleChange} name="username" id="username" className="block w-full font-fredoka py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Username" required /> */}
                                                </div>
                                            </div>
                                            <div className='mt-2'>
                                                <div className="flex gap-2">
                                                    <label htmlFor="email" className="after:content-['*'] after:ml-0.5 after:text-red-500 block font-medium font-fredoka text-base text-gray-900 dark:text-gray-300">Your email</label>
                                                ...
                                                <div className="relative flex items-center mt-2">
                                                    ...
                                                    <Field type="email" name="email" id="email" className="block w-full font-fredoka py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="your@mail.com" />


                                                    {/* <input type="email" value={user.email} onChange={handleChange} name="email" id="email" className="block w-full font-fredoka py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="your@mail.com" required /> */}
                                                </div>
                                            </div>
                                            <div className='mt-2'>
                                                <div className="flex gap-2">
                                                    <label htmlFor="password" className="after:content-['*'] after:ml-0.5 after:text-red-500 block font-medium font-fredoka text-base text-gray-900 dark:text-gray-300">Your password</label>
                                                ...
                                                <div className="relative flex items-center mt-2">
                                                    ...
                                                    <Field type="password" name="password" id="password" placeholder="••••••••" className="block w-full font-fredoka py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                                            ...
                                            <div className="flex mt-4 items-start font-fredoka">
                                            ...
                                            <button type="submit" className="w-full mt-6 font-dynaPuff text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create an account</button>
                                            <p className="text-sm mt-3 font-fredoka font-light text-gray-500 dark:text-gray-400">

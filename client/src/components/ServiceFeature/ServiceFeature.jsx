        ...
        <div>
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="max-w-xl mb-10 md:mx-auto mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    <h2 className="max-w-lg font-dynaPuff mb-6 text-3xl text-center font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                    ...
                    <p className="text-base text-center font-fredoka text-gray-700 md:text-lg">
                ...
                <div className="grid grid-cols-3 lg:w-5/6 lg:mx-auto mb-10 sm:grid-cols-3 lg:grid-cols-3">
                    <div className="text-center">
                        ...
                        <h6 className="mb-2 font-dynaPuff font-semibold leading-5">Free delivery</h6>
                    </div>
                    <div className="text-center">
                        <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-[#F9B658]/70 sm:w-22 sm:h-22">
                            <BsCalendar2Week className="w-10 h-10 text-[#E96952] sm:w-9 sm:h-9" />
                        </div>
                        <h6 className="mb-2 font-dynaPuff font-semibold leading-5">7-day delivery</h6>
                    </div>
                    <div className="text-center">
                        <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-[#F9B658]/70 sm:w-22 sm:h-22">
                            <BsCash className="w-10 h-10 text-[#E96952] sm:w-9 sm:h-9" />
                        </div>
                        <h6 className="mb-2 font-dynaPuff font-semibold leading-5">Refund</h6>
                    </div>

...
export interface ApiContactContact extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['Pending', 'Complete']> &
...
export interface ApiMasonryGridMasonryGrid extends Schema.SingleType {
  collectionName: 'masonry_grids';
  info: {
    singularName: 'masonry-grid';
    pluralName: 'masonry-grids';
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    status: Attribute.Enumeration<['Paid', 'Unpaid', 'Refund']> &
      Attribute.DefaultTo<'Unpaid'>;
    total: Attribute.Decimal & Attribute.Required;
    stripe_checkout_session: Attribute.String;
    tracking_id: Attribute.String &
      Attribute.DefaultTo<'Tracking ID will be issued soon.'>;
    deliveryStatus: Attribute.Enumeration<['Delivered', 'Pending', 'Return']> &
      Attribute.DefaultTo<'Pending'>;
    shipping_address: Attribute.JSON;
    phone_number: Attribute.String;
    order_metadata: Attribute.JSON;
    hosted_invoice_url: Attribute.String;
    invoice_pdf: Attribute.String;
    email: Attribute.Email;
    products: Attribute.Relation<
      'api::order.order',
      'manyToMany',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::masonry-grid.masonry-grid': ApiMasonryGridMasonryGrid;
